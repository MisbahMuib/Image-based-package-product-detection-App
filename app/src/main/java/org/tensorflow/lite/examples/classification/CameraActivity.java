...
//  private Model model = Model.FLOAT;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    // Text to speech object of class (custom language and time)
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        try {
          if (!pepsodent && recognitionTextView.getText().toString().equalsIgnoreCase("2 Pepsodent") && confi > 99) {
//            mp2.start();
            ...
            if (timeA == 0) {
              ...
              textToSpeech.speak("Pepsodent price 40 taka", TextToSpeech.QUEUE_FLUSH, null, null);
...
//                toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
            ...
            if (timeA == 0) {
              ...
              textToSpeech.speak("Harpic price 110 taka", TextToSpeech.QUEUE_FLUSH, null, null);
//              toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
              pricee.setText("110");
...
//              toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
              pricee.setText("40");
              textToSpeech.speak("Lux soap price 40 taka", TextToSpeech.QUEUE_FLUSH, null, null);
...
//                toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
            ...
            if (timeA == 0) {
              ...
              EasySharedPref.write("item", "PepsodentToothPowder");
              EasySharedPref.write("price","25");

              item.setText("PepsodentToothPowder");
              itemImage.setImageResource(R.drawable.toothpaste);
//              toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
              pricee.setText("25");
              textToSpeech.speak("Pepsodent Tooth Powder price 25 taka", TextToSpeech.QUEUE_FLUSH, null, null);
...
//                toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
                pricee.setText("25");
                textToSpeech.speak("Pepsodent Tooth Paste price 25 taka", TextToSpeech.QUEUE_FLUSH, null, null);
          ...
          else if (!vim && recognitionTextView.getText().toString().equalsIgnoreCase("4 Vim") && confi > 99) {
...
//              toneGen1.startTone(ToneGenerator.TONE_CDMA_PIP, 150);
              pricee.setText("12");
              textToSpeech.speak("Vim bar price 12 taka", TextToSpeech.QUEUE_FLUSH, null, null);
    ...
    switch (requestCode){
      case 10:
        if(resultCode==RESULT_OK && data!=null){
          ...
          // Recieve command for showing cart page
          ...
          // Recieve command for deleting items from cart
